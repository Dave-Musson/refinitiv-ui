...
describe('Accessibility color', () => {
  ...
  describe('Color localized', () => {
    ...
    it('Should have color tones', async () => {
      expect(colorLocalized('#ff9999').lightIntense).to.equal('VERY_LIGHT');
      expect(colorLocalized('#ff4d4d').lightIntense).to.equal('LIGHT');
      expect(colorLocalized('#b30000').lightIntense).to.equal('DARK');
      expect(colorLocalized('#330000').lightIntense).to.equal('VERY_DARK');
    }); 
    it('Should have color name when color value match with css color name', async () => {
